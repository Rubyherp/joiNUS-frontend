...
export default function ForgotPassword() {
    ...
    const { resetPassword, setNewPassword } = useContext(UserContext);
    ...
    const handleReset = async () => {
        ...
        try {
            await setNewPassword(email, otp, password);
                    ...
                    >
                        ...
                        >
                            {loading ? (
                                ...
                                <Text className="text-lg text-white font-semibold">Send Reset Code</Text>
                            )}
                        </LinearGradient>
                    </TouchableOpacity>
                    <Spacer height={10} />
                            ...
                            >
                                ...
                                >
                                    {loading ? (
                                        ...
                                        <Text className="text-lg text-white font-semibold">Reset Password</Text>
                                    )}
                                </LinearGradient>
                            </TouchableOpacity>
                        </>
